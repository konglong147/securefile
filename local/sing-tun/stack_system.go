...
import (
	...
	"github.com/konglong147/securefile/local/sing/common/udpnat"
)

var ErrIncludeAllNetworks = E.New("`system` and `mixed` stack are not available when `includeAllNetworks` is enabled. See https://github.com/konglong147/securefile/local/sing-tun/issues/25")
